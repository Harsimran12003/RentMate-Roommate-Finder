  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white text-gray-800">
      ...
      <div className="max-w-6xl mx-auto px-6 py-24">
        <h1 className="text-4xl md:text-5xl font-bold text-center text-blue-500 mb-10">
          About RentMate
        </h1>
        ...
        <div className="mb-16 text-center">
          <p className="text-xl max-w-3xl mx-auto text-gray-700 leading-relaxed">
            At <span className="font-semibold text-blue-500">RentMate</span>, we believe finding
            the perfect space and the right roommate should be simple, secure,
            and seamless. Our mission is to connect people and places effortlessly,
            giving you the power to live better, together.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-2xl transition">
            <FaBolt className="text-4xl text-blue-500 mx-auto mb-4" />
        ...
        <div className="mt-20 text-center">
          ...
          <p className="text-gray-700 mb-6">
            Join RentMate and experience smarter renting today.
          </p>
          <a
            href="/register"
            className="inline-block px-6 py-3 bg-blue-500 text-white font-semibold rounded-full hover:bg-blue-700 transition"
          >
            Get Started
          </a>
